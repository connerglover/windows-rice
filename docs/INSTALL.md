...
3. Install Vencord through its official installer if wanted, then enable the provided theme. For Spotify/Spicetify and Cider 2, follow [music theme setup](MUSIC-THEMES.md). Browser/Discord security controls are not bypassed.

...
$mods=@{Taskbar='windows-11-taskbar-styler';StartMenu='windows-11-start-menu-styler';NotificationCenter='windows-11-notification-center-styler';TaskbarSize='taskbar-icon-size'}
